        ...
        <section className="relative container mx-auto px-4 py-20 text-center overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <p className="text-xl md:text-2xl text-green-700 mb-8 max-w-4xl mx-auto leading-relaxed">
              Direct from our certified organic farm in Rajasthan to your wellness journey. Discover the power of nature's most nutritious superfood - 
              fresh moringa leaves, premium powder, and tender drumsticks, grown with organic farming expertise.
            </p>
